class User:
    ...
    def get_info(self):
        print(f"Foydalanuvchi nomim '{self.username}', to'liq ismim '{self.toliqism}' va menga murojaat qilishingiz uchun => {self.email}")

user1 = User("azamat_developer","Azamat Jumabayev", 20, "azamatjumabayev8774@gmail.com")
